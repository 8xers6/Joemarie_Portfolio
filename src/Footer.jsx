    ...
    <footer className="bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white text-center py-1">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center gap-4 mb-4">
          ...
          <a href="www.linkedin.com/in/joemarie-jacinto-429401310" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-400 transition-colors duration-300">
            <FaLinkedin size={24} />
          </a>
        </div>
      </div>
